...
Q_CONSTINIT const QMetaObject NetworkManager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNetworkManagerENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<MsgType &, std::false_type>,
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->receivedMessage((*reinterpret_cast< std::add_pointer_t<MsgType&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (NetworkManager::*)(MsgType & , const QByteArray & );
            if (_t _q_method = &NetworkManager::receivedMessage; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void NetworkManager::receivedMessage(MsgType & _t1, const QByteArray & _t2)
{
